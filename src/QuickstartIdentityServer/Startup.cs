...
namespace QuickstartIdentityServer
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IResourceOwnerPasswordValidator, Security.ResourceOwnerPasswordValidator>();
            services.AddTransient<IProfileService, Security.ProfileService>();
